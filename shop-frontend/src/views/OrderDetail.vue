<template>
  <div class="order-detail-page">
    ...
    <div v-else class="order-content">
      ...
      <!-- 物流信息 -->
      <div v-if="order.status === 'shipped' || order.status === 'completed'" class="logistics-section">
        <div class="section-title">物流信息</div>
        <div class="logistics-info">
          <div class="logistics-company">快递公司：顺丰速运</div>
          <div class="logistics-no">运单号：SF1234567890</div>
        </div>
      </div>
